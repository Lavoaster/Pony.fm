...
namespace Poniverse\Ponyfm\Util;
...
class TagParser
{
     ...
     * @throws \Exception
     */
    public function parseOriginalTags(\Symfony\Component\HttpFoundation\File\File $file, User $artist, string $audioCodec)
    {
        //==========================================================================================================
     ...
     * @return int
     */
    public function getGenreId(string $genreName)
    {
        $existingGenre = Genre::withTrashed()->where('name', $genreName)->first();
     ...
     * @return int|null
     */
    public function getAlbumId(int $artistId, $albumName, $coverId = null)
    {
        if (null === $albumName) {
            return null;
        }
